...
$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (response){
        ...
        // $(".new").map([2,3,21,2], (item) => {
        //   console.log(item);
        // // })
        // console.log($("new").append($("li")))
        // $.each(response, (res)=>{
        ...
        // $(".new").append(
          ...
          // $(".player-name").html(response[0].first_name)
          $.map(response, item => {
            full_name = `${item.first_name} ${item.last_name}`
              console.log(item.first_name, '8888888');
            //   // $("#playerName").text(full_name)
              // $("#playerSlider").append(`
              // <li>
              //   <a href="#">
              //       <div class=playerFig>
              ...
              //               <li><span>${full_name}</span> <span><img src=${item.image.url}
              //                                                       alt=image></span></li>
              //               <li class=playinfodetails>${item.height}</li>
              //               <li class=playerInfo><span>${item.position}</span> <span><i class="fa fa-heart"></i>${item.number}</span>
              //               </li>
              //           </ul>
              //       </div>
              //     </a>
              //   </li> 
              // `)
            //   // $("#playerNumber").html(item.number)
            })
            // )

      }
      // success: function (response) {
      //   terminalOwners = response;
      //   terminalOwners = $.map(response, function (obj) {
      //     return { id: obj.id, text: obj.name };
      //   });
      //   terminalOwners.unshift({
      //     id: "",
      //     text: "Select Terminal Owner",
      //   });
      //   $("#terminal_owner").select2({
      //     data: terminalOwners,
      //   });
      //   $("#terminal_owner_search").select2({
      //     data: terminalOwners,
      //   });
      // },
    });
